...
pub struct Point(pub(crate) PGA3D);
#[derive(Debug, Clone, PartialEq)]
...
#[derive(Debug, Clone, PartialEq)]
pub struct Plane(pub(crate) PGA3D);
...
mod tests {
    ...
    #[test]
    fn join_two_points_same_as_dual_of_meeting_duals() {
        let p0 = &PGA3D::e123();
        let p1 = &(PGA3D::e123() + PGA3D::e032());

        let line: PGA3D = !&(!p0 ^ !p1);
        assert_eq!(line, PGA3D::e23());
